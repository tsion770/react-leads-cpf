...
const LeadsForm = (props) => {
    ...
    <div >
        ...
        <Form className="form" className={classes.root} noValidate autoComplete="off">
            ...
            <Field id="standard-basic" name="prenom" className="input" label="Prenom"/>
            <ErrorMessage name="prenom" component="div" className="error"/><br/>

            <label htmlFor="nom" className="label"> Votre Nom de Famille </label><br/>
            <Field type="text" name="nom" className="input" label="Nom"/>
            <ErrorMessage name="nom" component="div" className="error"/> <br/>

            <label htmlFor="numeroDeTelephone" className="label"> Votre Numero de Telephone </label><br/>
            <Field type="text" name="numeroDeTelephone" className="input" label="Numero de Telephone"/>
            <ErrorMessage name="numeroDeTelephone" component="div" className="error"/> <br/>

            <label htmlFor="posteActuelle" className="label"> Email </label><br/>
            <Field type="text" name="email" className="input" label="E-mail"/>
            ...
            <Field type="text" name="formation" className="input" label="Choix de Formation"/>
